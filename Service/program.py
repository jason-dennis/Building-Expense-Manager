    ...
    while True:
        ...
        if option == 4:
            ...
            if option == 0:
                ...
                Delete.delete_all_expenses(apartments, utilities, number=number)
            elif option == 1:
                [start, end] = options[option]()
                Delete.delete_expenses_consecutive_apartments(apartments, utilities, start, end)
            elif option == 2:
                [type, subtype] = options[option]()
                Delete.delete_expenses(apartments, utilities, type=type, subtype=subtype)
